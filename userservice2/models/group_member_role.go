...
type GroupMemberRole struct {
	...
	GroupMemberID int64       `json:"group_member_id" gorm:"not null;uniqueIndex:unique_member_role"`
	GroupRoleID   int64       `json:"group_role_id" gorm:"not null;uniqueIndex:unique_member_role"`
