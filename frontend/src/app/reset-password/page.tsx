...
export default function ResetPasswordPage() {
    ...
    return (
        <motion.div className={styles.resetContainer} initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }}>
            <motion.div className={styles.resetBox} initial={{ y: -20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.6 }}>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className={styles.inputGroup}>
                        ...
                        <input type="password" {...register("newPassword", { required: "Vui lòng nhập mật khẩu mới", minLength: { value: 6, message: "Mật khẩu ít nhất 6 ký tự" } })} className={styles.inputField} />
                    ...
                    <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }} type="submit" disabled={loading} className={styles.submitButton}>
